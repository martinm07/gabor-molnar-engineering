...
interface CompPartInfo {
  ...
  attrValue: string;
  // A list of part strings (a "part string" is a comma-seperated list of numbers e.g. "2,1,1" indicating "the first child of the first child of the second sibling" for example)
  //  that this component part has. The first item is the part string of the component part itself
  // parts: string[];
...
export const extractPartsFromCompStr = (bodyStr: string): CompPartInfo[] => {
  ...
  const [parsedBodyStr, docNodes] = reconstructHTMLString(
    body,
    {
      docContainer: body,
    },
...
const handleRemovedComponents = (
  ...
  while ((el = walker.nextNode() as Element)) {
    ...
    if (
      ...
      // Inherited data- attributes about components
      ...
      el.setAttribute("data-compDisinherited", "");
